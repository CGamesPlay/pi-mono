...
export class SessionManager {
	 ...
	 *
	 * @param branchFromId - The entry to attach the summary to (becomes parentId of the new entry).
	 * @param summary - LLM-generated summary of the abandoned path.
	 * @param details - Extension-specific metadata.
	 * @param fromHook - Whether the summary was generated by an extension hook.
	 * @param fromId - The previous leaf entry ID (the tip of the conversation being abandoned).
	 */
	branchWithSummary(
